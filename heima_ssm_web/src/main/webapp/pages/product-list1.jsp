                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <th class="sorting_id">ID</th>
                                <th class="sorting_productNum">编号</th>
                                <th class="sorting_productName">名称</th>
                                <th class="sorting_cityName">出发城市</th>
                                <th class="sorting_departureTimeStr">出发时间</th>
                                <th class="sorting_productPrice">产品价格</th>
                                <th class="sorting_productDesc">产品描述</th>
                                <th class="sorting_productStatusStr">屏蔽</th>
